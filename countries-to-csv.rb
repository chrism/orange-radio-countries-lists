...
def generateCSV(json, lang)
  en_json = getJsonFromUrl("/v2/localisations/#{CONTINENT_CODE}/countries", "en-EN")
  csv_string = CSV.generate do |csv|
    header = ["Code", "Name", "Radio count", "Review"]
    ...
    json["result"].each do |item|
      ...
      row = [item["code"],item["name"],country_count]
...
languages.each do |language|
  json = getJsonFromUrl("/v2/localisations/#{CONTINENT_CODE}/countries", language)
  puts "### #{language}"
  puts ""
